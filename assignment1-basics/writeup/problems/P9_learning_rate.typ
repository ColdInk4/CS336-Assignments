...
#plot("assets/P09_learning_rate_01_coarse_train.png")
#plot("assets/P09_learning_rate_02_coarse_valid.png")
#plot("assets/P09_learning_rate_03_coarse_tokens.png")
#plot("assets/P09_learning_rate_04_coarse_summary.png")
...
#plot("assets/P09_learning_rate_05_fine_train.png")
#plot("assets/P09_learning_rate_06_fine_valid.png")

从 validation loss 来看，1.5e-3 在 5000 steps 时表现最好，略优于 1e-3 和 2e-3，因此我选择 1.5e-3 作为最终长时间训练的学习率。

#plot("assets/P09_learning_rate_07_final_run.png")
...
b. 
#plot("assets/P09_learning_rate_08_edge_train.png")
#plot("assets/P09_learning_rate_09_edge_valid.png")
